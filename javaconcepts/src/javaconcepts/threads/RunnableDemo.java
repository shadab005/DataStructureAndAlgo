...
public class RunnableDemo implements Runnable {
	...
	RunnableDemo(String name) {
		// th=new Thread(this,name);//second step is to create a thread object using
		// runnable as argument and then call the start method
		// th.start();
	...
	public static void main(String[] args) {
		...
		System.out.println(th1.getName() + "  main thread ends here=======>");
	}
